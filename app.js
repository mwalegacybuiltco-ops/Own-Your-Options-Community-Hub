...
function updateIdentityUI(){
  ...
  setText("#accountButton",session?identity.initials:"Sign in");
  setText("#sidebarAvatar",session?identity.initials:"YO");
  setText("#sidebarMemberName",session?identity.name:"Your account");
  setText("#sidebarMemberRole",session?identity.role:"Own Your Options member");
  setText("#commentTemplate .avatar",identity.initials);
  setText("#commentTemplate strong",identity.name);
  const adminNav=document.querySelector(".admin-nav"), moderatorNav=document.querySelector(".moderator-nav");
  if(adminNav)adminNav.hidden=accessRole!=="Owner";
  if(moderatorNav)moderatorNav.hidden=accessRole!=="Moderator";
}
updateIdentityUI();
